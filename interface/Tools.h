...
void HHAnalyzer::fillTriggerEfficiencies(const Lepton & lep1, const Lepton & lep2, Dilepton & dilep) {
    ...
    if (lep1.isMu && lep2.isMu) {
        eff_lep1_leg1 = m_hlt_efficiencies["DoubleMuIsoMu17leg_RunLt274094"].get(p_hlt_lep1)[0];
        eff_lep1_leg2 = m_hlt_efficiencies["DoubleMuIsoMu8orIsoTkMu8leg_RunLt274094"].get(p_hlt_lep1)[0];
        //eff_lep1_tkleg2 = m_hlt_efficiencies["DoubleIsoMu17Mu8_TkMu8leg"].get(p_hlt_lep1)[0];
        eff_lep2_leg1 = m_hlt_efficiencies["DoubleMuIsoMu17leg_RunLt274094"].get(p_hlt_lep2)[0];
        eff_lep2_leg2 = m_hlt_efficiencies["DoubleMuIsoMu8orIsoTkMu8leg_RunLt274094"].get(p_hlt_lep2)[0];
        //eff_lep2_tkleg2 = m_hlt_efficiencies["DoubleIsoMu17Mu8_TkMu8leg"].get(p_hlt_lep2)[0];
    }
    else if (lep1.isMu && lep2.isEl) {
        eff_lep1_leg1 = m_hlt_efficiencies["MuEleIsoMu23leg_RunLt274094"].get(p_hlt_lep1)[0];
        eff_lep1_leg2 = m_hlt_efficiencies["EleMuIsoMu8leg_RunLt274094"].get(p_hlt_lep1)[0];
        eff_lep2_leg1 = m_hlt_efficiencies["EleMuLegHigPt"].get(p_hlt_lep2)[0];
        eff_lep2_leg2 = m_hlt_efficiencies["MuEleLegLowPt"].get(p_hlt_lep2)[0];
    }
    else if (lep1.isEl && lep2.isMu) {
        eff_lep1_leg1 = m_hlt_efficiencies["EleMuLegHigPt"].get(p_hlt_lep1)[0];
        eff_lep1_leg2 = m_hlt_efficiencies["MuEleLegLowPt"].get(p_hlt_lep1)[0];
        eff_lep2_leg1 = m_hlt_efficiencies["MuEleIsoMu23leg_RunLt274094"].get(p_hlt_lep2)[0];
        eff_lep2_leg2 = m_hlt_efficiencies["EleMuIsoMu8leg_RunLt274094"].get(p_hlt_lep2)[0];
    }
    else if (lep1.isEl && lep2.isEl){
        eff_lep1_leg1 = m_hlt_efficiencies["DoubleEleLegHigPt"].get(p_hlt_lep1)[0];
        eff_lep1_leg2 = m_hlt_efficiencies["DoubleEleLegLowPt"].get(p_hlt_lep1)[0];
        eff_lep2_leg1 = m_hlt_efficiencies["DoubleEleLegHigPt"].get(p_hlt_lep2)[0];
        eff_lep2_leg2 = m_hlt_efficiencies["DoubleEleLegLowPt"].get(p_hlt_lep2)[0];
    }
    else 
    ...
    if (lep1.isMu && lep2.isMu) {
        error_eff_lep1_leg1_up = m_hlt_efficiencies["DoubleMuIsoMu17leg_RunLt274094"].get(p_hlt_lep1)[2];
        error_eff_lep1_leg2_up = m_hlt_efficiencies["DoubleMuIsoMu8orIsoTkMu8leg_RunLt274094"].get(p_hlt_lep1)[2];
        //error_eff_lep1_tkleg2_up = m_hlt_efficiencies["DoubleIsoMu17Mu8_TkMu8leg"].get(p_hlt_lep1)[2];
        error_eff_lep2_leg1_up = m_hlt_efficiencies["DoubleMuIsoMu17leg_RunLt274094"].get(p_hlt_lep2)[2];
        error_eff_lep2_leg2_up = m_hlt_efficiencies["DoubleMuIsoMu8orIsoTkMu8leg_RunLt274094"].get(p_hlt_lep2)[2];
        //error_eff_lep2_tkleg2_up = m_hlt_efficiencies["DoubleIsoMu17Mu8_TkMu8leg"].get(p_hlt_lep2)[2];
    }
    else if (lep1.isMu && lep2.isEl) {
        error_eff_lep1_leg1_up = m_hlt_efficiencies["MuEleIsoMu23leg_RunLt274094"].get(p_hlt_lep1)[2];
        error_eff_lep1_leg2_up = m_hlt_efficiencies["EleMuIsoMu8leg_RunLt274094"].get(p_hlt_lep1)[2];
        error_eff_lep2_leg1_up = m_hlt_efficiencies["EleMuLegHigPt"].get(p_hlt_lep2)[2];
        error_eff_lep2_leg2_up = m_hlt_efficiencies["MuEleLegLowPt"].get(p_hlt_lep2)[2];
    }
    else if (lep1.isEl && lep2.isMu) {
        error_eff_lep1_leg1_up = m_hlt_efficiencies["EleMuLegHigPt"].get(p_hlt_lep1)[2];
        error_eff_lep1_leg2_up = m_hlt_efficiencies["MuEleLegLowPt"].get(p_hlt_lep1)[2];
        error_eff_lep2_leg1_up = m_hlt_efficiencies["MuEleIsoMu23leg_RunLt274094"].get(p_hlt_lep2)[2];
        error_eff_lep2_leg2_up = m_hlt_efficiencies["EleMuIsoMu8leg_RunLt274094"].get(p_hlt_lep2)[2];
    }
    else if (lep1.isEl && lep2.isEl){
        error_eff_lep1_leg1_up = m_hlt_efficiencies["DoubleEleLegHigPt"].get(p_hlt_lep1)[2];
        error_eff_lep1_leg2_up = m_hlt_efficiencies["DoubleEleLegLowPt"].get(p_hlt_lep1)[2];
        error_eff_lep2_leg1_up = m_hlt_efficiencies["DoubleEleLegHigPt"].get(p_hlt_lep2)[2];
        error_eff_lep2_leg2_up = m_hlt_efficiencies["DoubleEleLegLowPt"].get(p_hlt_lep2)[2];
    }
    ...
    if (lep1.isMu && lep2.isMu) {
        error_eff_lep1_leg1_down = m_hlt_efficiencies["DoubleMuIsoMu17leg_RunLt274094"].get(p_hlt_lep1)[1];
        error_eff_lep1_leg2_down = m_hlt_efficiencies["DoubleMuIsoMu8orIsoTkMu8leg_RunLt274094"].get(p_hlt_lep1)[1];
        //error_eff_lep1_tkleg2_down = m_hlt_efficiencies["DoubleIsoMu17Mu8_TkMu8leg"].get(p_hlt_lep1)[1];
        error_eff_lep2_leg1_down = m_hlt_efficiencies["DoubleMuIsoMu17leg_RunLt274094"].get(p_hlt_lep2)[1];
        error_eff_lep2_leg2_down = m_hlt_efficiencies["DoubleMuIsoMu8orIsoTkMu8leg_RunLt274094"].get(p_hlt_lep2)[1];
        //error_eff_lep2_tkleg2_down = m_hlt_efficiencies["DoubleIsoMu17Mu8_TkMu8leg"].get(p_hlt_lep2)[1];
    }
    else if (lep1.isMu && lep2.isEl) {
        error_eff_lep1_leg1_down = m_hlt_efficiencies["MuEleIsoMu23leg_RunLt274094"].get(p_hlt_lep1)[1];
        error_eff_lep1_leg2_down = m_hlt_efficiencies["EleMuIsoMu8leg_RunLt274094"].get(p_hlt_lep1)[1];
        error_eff_lep2_leg1_down = m_hlt_efficiencies["EleMuLegHigPt"].get(p_hlt_lep2)[1];
        error_eff_lep2_leg2_down = m_hlt_efficiencies["MuEleLegLowPt"].get(p_hlt_lep2)[1];
    }
    else if (lep1.isEl && lep2.isMu) {
        error_eff_lep1_leg1_down = m_hlt_efficiencies["EleMuLegHigPt"].get(p_hlt_lep1)[1];
        error_eff_lep1_leg2_down = m_hlt_efficiencies["MuEleLegLowPt"].get(p_hlt_lep1)[1];
        error_eff_lep2_leg1_down = m_hlt_efficiencies["MuEleIsoMu23leg_RunLt274094"].get(p_hlt_lep2)[1];
        error_eff_lep2_leg2_down = m_hlt_efficiencies["EleMuIsoMu8leg_RunLt274094"].get(p_hlt_lep2)[1];
    }
    else if (lep1.isEl && lep2.isEl){
        error_eff_lep1_leg1_down = m_hlt_efficiencies["DoubleEleLegHigPt"].get(p_hlt_lep1)[1];
        error_eff_lep1_leg2_down = m_hlt_efficiencies["DoubleEleLegLowPt"].get(p_hlt_lep1)[1];
        error_eff_lep2_leg1_down = m_hlt_efficiencies["DoubleEleLegHigPt"].get(p_hlt_lep2)[1];
        error_eff_lep2_leg2_down = m_hlt_efficiencies["DoubleEleLegLowPt"].get(p_hlt_lep2)[1];
    }
