...
void HHAnalyzer::registerCategories(CategoryManager& manager) {
...
void HHAnalyzer::analyze(const edm::Event& event, const edm::EventSetup&, const ProducersManager& producers) {
